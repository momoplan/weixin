...
public enum ErrorCode {
	...
	OK("0", "成功"), DATA_NOT_EXISTS("1", "无记录"), ERROR("500", "服务器错误"), CASELOT_NOT_EXISTS("506", "活动不存在"), CASELOTUSERINFO_NOT_EXISTS("501",
			...
			DIRECT_CHARGE_FAIL("601", "赠送彩金失败"), PACKET_NOT_EXIST("602", "红包不存在"), PACKET_STATUS_GETED("603", "已抢过红包"),PACKET_STATUS("1000", "系统赠送红包"), ORDER_NOT_PRIZE("604", "订单未开奖"), ACTION_EXPIRED("605", "活动关闭"), PACKET_EXPIRED("606", "红包已过期");
